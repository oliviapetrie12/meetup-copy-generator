 ...
 *
 * STATUS: Not wired from the KBYG UI (Quick Import is paste-only). Kept for a future
 * URL-ingestion pass — see `src/eventUrlImport/DISABLED.md`. Intended use: Vercel
 * `api/fetch-event-page.js` and optional Vite dev middleware (both commented out).
 */
